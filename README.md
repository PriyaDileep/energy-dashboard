...
1. Clone the repo
2. Open `EnergyDashboard.xcodeproj` in Xcode 15 or later
3. Select the **iPhone 17 Pro** simulator (the submission was developed and visually verified on this device)
4. Press **Cm+R** to build and run
